...
def test():
    ...
    html = '''                        <div class="tab-pane" id="campus4">
                            <div class="calendar">
                                <div class="calendar-header panel panel-default">
                                    <table>
                                        <th id="second-flor-4">Этаж 2</th>
                                        <th id="third-flor-4">Этаж 3</th>
                                        <th id="fourth-flor-4">Этаж 4</th>
                                        <th id="fifth-flor-4">Этаж 5</th>
                                        <th id="sixth-flor-4">Этаж 6</th>
                                        <th id="seventh-flor-4">Этаж 7</th>
                                        <th id="eighth-flor-4">Этаж 8</th>
                                        <th id="nineth-flor-4">Этаж 9</th>
                                    </table>
                                </div>
                            </div>
                            <div class="campus-dir-map">
                                <div class="campus-map4" id="flor-4-2">
                                    <div id="right-top-side-row-4-2" class="campus-room-row">
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">201</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">202</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">204</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">203</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">205</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">206</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">208</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">207</a>


                                        </div>
                                    </div>
                                    <div id="right-bot-side-row-4-2" class="campus-room-row">
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">211</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">212</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">210</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">209</a>


                                        </div>
                                        <div id="service-room" name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room"></a>
                                        </div>
                                    </div>
                                    <div id="left-top-side-row-4-2" class="campus-room-row">
                                        <div id="service-room" name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room"></a>
                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">221</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">222</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">224</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">223</a>


                                        </div>
                                        <div id="left-bot-side-row-4-2" class="campus-room-row">
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">219</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">220</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">218</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">217</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">215</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">216</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">214</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">213</a>
                                ...
                                <div class="campus-map4" id="flor-4-3">
                                    <div id="right-top-side-row-4-2" class="campus-room-row">
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">301</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">302</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">304</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">303</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">305</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">306</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">308</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">307</a>
                                    ...
                                    <div id="right-bot-side-row-4-2" class="campus-room-row">
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">311</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">312</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">310</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">309</a>
                                    ...
                                    <div id="left-top-side-row-4-2" class="campus-room-row">
                                        ...
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">321</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">322</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">324</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">323</a>


                                        </div>
                                        <div id="left-bot-side-row-4-2" class="campus-room-row">
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">319</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">320</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">318</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">317</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">315</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">316</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">314</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">313</a>
                                ...
                                <div class="campus-map4" id="flor-4-4">
                                    <div id="right-top-side-row-4-2" class="campus-room-row">
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">401</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">402</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">404</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">403</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">405</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">406</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">408</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">407</a>
                                    ...
                                    <div id="right-bot-side-row-4-2" class="campus-room-row">
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">411</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">412</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">410</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">409</a>
                                    ...
                                    <div id="left-top-side-row-4-2" class="campus-room-row">
                                        ...
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">421</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">422</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">424</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">423</a>


                                        </div>
                                        <div id="left-bot-side-row-4-2" class="campus-room-row">
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">419</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">420</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">418</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">417</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">415</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">416</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">414</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">413</a>
                                ...
                                <div class="campus-map4" id="flor-4-5">
                                    <div id="right-top-side-row-4-2" class="campus-room-row">
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">501</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">502</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">504</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">503</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">505</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">506</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">508</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">507</a>
                                    ...
                                    <div id="right-bot-side-row-4-2" class="campus-room-row">
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">511</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">512</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">510</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">509</a>
                                    ...
                                    <div id="left-top-side-row-4-2" class="campus-room-row">
                                        ...
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">521</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">522</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">524</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">523</a>


                                        </div>
                                        <div id="left-bot-side-row-4-2" class="campus-room-row">
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">519</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">520</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">518</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">517</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">515</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">516</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">514</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">513</a>
                                ...
                                <div class="campus-map4" id="flor-4-6">
                                    <div id="right-top-side-row-4-2" class="campus-room-row">
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">601</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">602</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">604</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">603</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">605</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">606</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">608</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">607</a>
                                    ...
                                    <div id="right-bot-side-row-4-2" class="campus-room-row">
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">611</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">612</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">610</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">609</a>
                                    ...
                                    <div id="left-top-side-row-4-2" class="campus-room-row">
                                        ...
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">621</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">622</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">624</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">623</a>


                                        </div>
                                        <div id="left-bot-side-row-4-2" class="campus-room-row">
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">619</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">620</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">618</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">617</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">615</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">616</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">614</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">613</a>
                                ...
                                <div class="campus-map4" id="flor-4-7">
                                    <div id="right-top-side-row-4-2" class="campus-room-row">
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">701</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">702</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">704</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">703</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">705</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">706</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">708</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">707</a>
                                    ...
                                    <div id="right-bot-side-row-4-2" class="campus-room-row">
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">711</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">712</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">710</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">709</a>
                                    ...
                                    <div id="left-top-side-row-4-2" class="campus-room-row">
                                        ...
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">721</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">722</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">724</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">723</a>


                                        </div>
                                        <div id="left-bot-side-row-4-2" class="campus-room-row">
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">719</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">720</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">718</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">717</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">715</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">716</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">714</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">713</a>
                                ...
                                <div class="campus-map4" id="flor-4-8">
                                    <div id="right-top-side-row-4-2" class="campus-room-row">
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">801</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">802</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">804</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">803</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">805</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">806</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">808</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">807</a>
                                    ...
                                    <div id="right-bot-side-row-4-2" class="campus-room-row">
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">811</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">812</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">810</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">809</a>
                                    ...
                                    <div id="left-top-side-row-4-2" class="campus-room-row">
                                        ...
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">821</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">822</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">824</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">823</a>


                                        </div>
                                        <div id="left-bot-side-row-4-2" class="campus-room-row">
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">819</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">820</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">818</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">817</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">815</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">816</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">814</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">813</a>
                                ...
                                <div class="campus-map4" id="flor-4-9">
                                    <div id="right-top-side-row-4-2" class="campus-room-row">
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">901</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">902</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">904</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">903</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">905</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">906</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">908</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">907</a>
                                    ...
                                    <div id="right-bot-side-row-4-2" class="campus-room-row">
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">911</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">912</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">910</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">909</a>
                                    ...
                                    <div id="left-top-side-row-4-2" class="campus-room-row">
                                        ...
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">921</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">922</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">924</a>


                                        </div>
                                        <div name="room-one" class="campus-room-cell">
                                            <a href="#campus-room-1" class="a_room">923</a>


                                        </div>
                                        <div id="left-bot-side-row-4-2" class="campus-room-row">
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">919</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">920</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">918</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">917</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">915</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">916</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">914</a>


                                            </div>
                                            <div name="room-one" class="campus-room-cell">
                                                <a href="#campus-room-1" class="a_room">913</a>
