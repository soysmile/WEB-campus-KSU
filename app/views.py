...
def upload_file():
    if request.method == 'POST':
        ...
        # links = []
        # import json
        # photos = flickr.photos.search(user_id='152646046@N06', per_page='100')
        # json_ = json.loads(photos)
        # for ph in json_.get('photos').get('photo'):
        #     links.append(
        #         'http://farm{}.staticflickr.com/{}/{}_{}_b.jpg'.format(ph.get('farm'), ph.get('server'), ph.get('id'),
        #                                                                ph.get('secret')))
        # print(links)
        #
