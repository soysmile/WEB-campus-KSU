...
register_main = Table('register_main', post_meta,
    ...
    Column('form_of_education', String(length=50)),
)
...
def upgrade(migrate_engine):
    ...
    post_meta.tables['register_main'].columns['form_of_education'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['register_main'].columns['form_of_education'].drop()
